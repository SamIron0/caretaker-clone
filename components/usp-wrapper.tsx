  ...
  return (
    <div
      className={classNames(
        'relative order-[var(--order)] flex min-h-[38rem] min-w-full snap-center flex-col items-center overflow-hidden rounded-[4.8rem] border text-center md:order-none md:min-w-0 py-8',
        className,
