    ...
    <>
      <div
        ...
        className={classNames(
          "relative z-[-1] mt-[12rem] md:my-[25.2rem]",
      ...
      <div className="flex mb-[12rem] flex-shrink-0 snap-x snap-mandatory gap-3 overflow-x-auto px-6 pb-12 md:grid md:grid-cols-8 md:gap-6 md:overflow-x-hidden md:px-8">
