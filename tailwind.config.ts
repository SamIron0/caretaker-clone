...
module.exports = {
  ...
  theme: {
    ...
    backgroundImage: {
      "primary-gradient": 'linear-gradient(92.88deg, rgb(59, 89, 191) 9.16%, rgb(76, 77, 214) 43.89%, rgb(83, 73, 225) 64.72%)',
      "page-gradient": "radial-gradient(ellipse 80% 50% at 50% -20%,rgba(100,119,208,0.3),transparent);",
